...
!function (e) {
    ...
    b.prototype = {
        constructor: b, init: function (e) {
            ...
            var e = this;
            e.isDisabled = !0, e.$element.attr("disabled", "disabled"), e.$container.find(".kv-fileinput-caption").addClass("file-caption-disabled"), e.$container.find(".btn-file, .fileinput-remove").attr("disabled", !0)
        }, enable: function () {
            var e = this;
            e.isDisabled = !1, e.$element.removeAttr("disabled"), e.$container.find(".kv-fileinput-caption").removeClass("file-caption-disabled"), e.$container.find(".btn-file, .fileinput-remove").removeAttr("disabled")
            ...
            return e.showUpload ? (e.isDisabled && (n = " disabled "), t = d(e.uploadUrl) || e.isDisabled ?
                '<button style="display:none" type="submit" class="' + i + '"' + n + ">" + e.uploadIcon + e.uploadLabel + "</button>" :
                '<a href="' + e.uploadUrl + '" class="' + i + '"' + n + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        }
